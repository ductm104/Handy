...
// create residency sets only when both the SDK and deployment target support them
#if (!TARGET_CPU_X86_64 && TARGET_OS_OSX && __MAC_OS_X_VERSION_MAX_ALLOWED >= 150000 && __MAC_OS_X_VERSION_MIN_REQUIRED >= 150000) || \
