; Custom NSIS template for HanhCute with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\HanhCute for portable
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "HanhCute Portable Mode"
    FileClose $0
